...
namespace ZooApp.MvcClient.Controllers
{
    public class AnimalFoodsController : Controller
    {
        ...
        {
            var result = service.GetViewFoodTotal();
        ...
        public ActionResult Create([Bind(Include = "Id,Quantity,AnimalId,FoodId")] AnimalFood animalFood)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Quantity,AnimalId,FoodId")] AnimalFood animalFood)
        {
            if (ModelState.IsValid)
            {
